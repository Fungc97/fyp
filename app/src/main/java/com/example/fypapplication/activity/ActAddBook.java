...
public class ActAddBook extends AppCompatActivity {
    ...
    private ArrayList<String> retrieveTitleListFrom(ArrayList<Map<String, String>> lmRecords) {
    ...
    private String capitaliseFirstLetter(String s) {
    ...
    private ArrayList<String> retrieveLocationListFrom(ArrayList<Map<String, String>> lmRecords2) {
